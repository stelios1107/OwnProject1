...
//
// ΠΡΟΣΟΧΗ:
// Όσο το key είναι μέλος του map, οποιαδήποτε μεταβολή στο περιεχόμενό του (στη μνήμη που δείχνει) δεν πρέπει
// να αλλάζει τη σχέση διάταξης (compare) με οποιοδήποτε άλλο key, διαφορετικά έχει μη ορισμένη συμπεριφορά.
...
// Όπως και με την συνάρτηση compare, αλλαγές στο περιεχόμενο των keys δεν θα πρέπει να αλλάζουν την
// τιμή που επιστρέφει η συνάρτηση κατακερματισμού, διαφορετικά η συμπεριφορά είναι μη ορισμένη.
